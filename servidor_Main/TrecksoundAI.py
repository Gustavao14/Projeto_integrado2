...
def TrecksoundAI():
    ...
    # PERGUNTAS
    # ============================================================
    def iniciar_conversa(texto):
        while True:
            resposta = input(texto)
            if resposta == "quero indicações":
                return resposta
            print("não entendi. Digite 'quero indicações' para continuar.")
    ...
    def main():
        ...
        iniciar_conversa("Digite 'quero indicações' para começar: ")
