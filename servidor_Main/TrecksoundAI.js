...
// ============================================================
// DATASET (igual ao TrecksoundAI.py)
// ============================================================
const MUSICAS = [
...
// ============================================================
// LÓGICA DO KNN (igual ao TrecksoundAI.py)
// ============================================================
...
// ============================================================
// ROTA DO CHAT (única rota /trecksound, sem duplicatas)
// ============================================================
app.post('/trecksound', (req, res) => {
    ...
    if (estado.etapa === "clima") {
        ...
        if (CLIMAS_VALIDOS.includes(escolha)) {
            ...
            return res.json({
                resposta: ">>> TOCAR AGORA: " + musicaEscolhida.nome + " (" + musicaEscolhida.estilo + ")"
            });
        }
        return res.json({
